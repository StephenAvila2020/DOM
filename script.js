...
document.querySelector(".alumni-container").innerHTML = 
printStudentToDOM("Mark", "Math", "Mayor", "A");

// printStudentToDOM("Austin", "His mom is cool")
// printStudentToDOM("Barry", "Knows a lot about coding")
// printStudentToDOM("Derek", "plays guitar")